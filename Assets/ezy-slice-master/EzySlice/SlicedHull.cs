...
namespace EzySlice {
    ...
    public sealed class SlicedHull {
        ...
        public GameObject CreateUpperHull(GameObject original, Material crossSectionMat, bool bChild = false) 
        {
            ...
            if (newObject != null) 
            {
                ...
                else
                {
                    ...
                    newObject.transform.localRotation = original.transform.parent.localRotation;
                    newObject.transform.localScale = original.transform.parent.localScale;
                }
        ...
        public GameObject CreateLowerHull(GameObject original, Material crossSectionMat, bool bChild = false) 
        {
